...
var loader = async ({ request }) => {
  var _a;
  let userId = await (0, import_session.getUserId)(request);
  let jokes = userId ? await import_db.db.joke.findMany({
    take: 100,
...
//# sourceMappingURL=/build/routes/jokes[.]rss-PXPGAJKW.js.map
